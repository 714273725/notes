...
CFLAGS="-Os -fpic -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -isysroot $NDK/sysroot -I$NDK/sysroot/usr/include/$CROSS -D__ANDROID_API__=$ANDROID_VERSION -U_FILE_OFFSET_BITS"
